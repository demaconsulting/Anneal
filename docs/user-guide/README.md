...
> changes, or when what a user sees from `@helper` or `@architecture-design` changes. No interior
> change to Anneal — a new agent, a reworded standard, a new contract-check failure, a change to how
> routing or repairs work — may require an edit here.
